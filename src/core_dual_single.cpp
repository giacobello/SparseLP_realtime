...
void cpdip_slp_core( isignal_single sig, settings_single set, variables_single var, solution_single sol)
{
 ...
 float mu, pinfeas, dinfeas, relgap, cxk;
 float axa, asa, mu_aff, sigma;
 float etak, ap, ad;
...
# 165 "core_dual.cpp"
  ...
  tools_axpy( M, ad, var.rs, var.lk);
  tools_axpy( N, ad, var.dss, var.sk);
...
void init_variables( isignal_single sig, settings_single set, variables_single *var, solution_single *sol){
 ...
 sol->a = (float*) malloc(sig.n*sizeof(float));
 sol->kp = (int*) malloc(sizeof(float));
 sol->status = (int*) malloc(sizeof(float));


 var->c = (float*) malloc( (2*sig.m+2*sig.n)*sizeof(float));

 var->b = (float*) malloc(sig.m*sizeof(float));

 var->xk = (float*) malloc( (2*sig.m+2*sig.n)*sizeof(float));

 var->sk = (float*) malloc( (2*sig.m+2*sig.n)*sizeof(float));

 var->lk = (float*) malloc( sig.m*sizeof(float));

 var->rb = (float*) malloc( sig.m*sizeof(float));

 var->rc = (float*) malloc( (2*sig.m+2*sig.n)*sizeof(float));

 var->tn = (float*) malloc( sig.n*sizeof(float));

 var->skm1 = (float*) malloc( (2*sig.m+2*sig.n)*sizeof(float));

 var->xkskm1 = (float*) malloc( (2*sig.m+2*sig.n)*sizeof(float));

 var->d1 = (float*) malloc( sig.m*sizeof(float));

 var->d2 = (float*) malloc( sig.n*sizeof(float));

 var->T = (float*) malloc( sig.n*sig.m*sizeof(float));

 var->Kp = (float*) malloc( sig.m*sig.m*sizeof(float));

 var->Kpp = (float*) malloc( sig.m*sig.m*sizeof(float));

 var->tN = (float*) malloc( (2*sig.m + 2*sig.n)*sizeof(float));

 var->tN2 = (float*) malloc( (2*sig.m + 2*sig.n)*sizeof(float));

 var->tm = (float*) malloc( sig.m*sizeof(float));

 var->ra = (float*) malloc( sig.m*sizeof(float));

 var->dsa = (float*) malloc( (2*sig.m + 2*sig.n)*sizeof(float));

 var->dxa = (float*) malloc( (2*sig.m + 2*sig.n)*sizeof(float));

 var->rs = (float*) malloc( (sig.m)*sizeof(float));

 var->dss = (float*) malloc( (2*sig.m + 2*sig.n)*sizeof(float));

 var->dxs = (float*) malloc( (2*sig.m + 2*sig.n)*sizeof(float));
