...
# 22 "core_primal.cpp" 2





# 1 "core_primal_double.h" 1
# 1 "core_primal.h"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "core_primal.h"
...
void cpdip_slp_core( isignal_double sig, settings_double set, variables_double var, solution_double sol)
{
 ...
 double mu, pinfeas, dinfeas, relgap, cxk;
 double asa, aza, mu_aff, sigma;
 double etak, ap, ad;
...
# 76 "core_primal.cpp"
  ...
  pinfeas = sqrt( pow(tools_nrm2( M, var.rh1),2) + pow(tools_nrm2( M, var.rh2),2) )
  ...
  dinfeas = sqrt( pow(tools_nrm2( sig.n, var.rc1),2) + pow(tools_nrm2( M, var.rc2),2) )
   / (1.0+sqrt(M));
...
# 206 "core_primal.cpp"
  ...
  asa = (tools_stepsize( M, var.dsa2, var.sk2) < asa ? tools_stepsize( M, var.dsa2, var.sk2) : asa);

  aza = tools_stepsize( M, var.dza1, var.zk1);
  aza = (tools_stepsize( M, var.dza2, var.zk2) < asa ? tools_stepsize( M, var.dza2, var.zk2) : asa);
...
# 354 "core_primal.cpp"
  ...
  etak = 1.0-0.1/((double)k*k*k);

  ap = tools_stepsize_scale( M, etak, var.dss1, var.sk1);
  ap = (ap < tools_stepsize_scale( M, etak, var.dss2, var.sk2) ? ap : tools_stepsize_scale( M, etak, var.dss2, var.sk2));

  ad = tools_stepsize_scale( M, etak, var.dzs1, var.zk1);
  ad = (ad < tools_stepsize_scale( M, etak, var.dzs2, var.zk2) ? ad : tools_stepsize_scale( M, etak, var.dzs2, var.zk2));
...
void init_variables( isignal_double sig, settings_double set, variables_double *var, solution_double *sol){
 ...
 sol->a = (double*) malloc(sig.n*sizeof(double));
 sol->kp = (int*) malloc(sizeof(double));
 sol->status = (int*) malloc(sizeof(double));


 var->b = (double*) malloc(M*sizeof(double));

 var->uk = (double*) malloc( sig.n*sizeof(double));
 var->vk = (double*) malloc( M*sizeof(double));

 var->g = (double*) malloc( M*sizeof(double));
 var->gs = (double*) malloc( M*sizeof(double));

 var->sk1 = (double*) malloc( M*sizeof(double));
 var->sk2 = (double*) malloc( M*sizeof(double));

 var->zk1 = (double*) malloc( M*sizeof(double));
 var->zk2 = (double*) malloc( M*sizeof(double));

 var->rh1 = (double*) malloc( M*sizeof(double));
 var->rh2 = (double*) malloc( M*sizeof(double));

 var->p1 = (double*) malloc( M*sizeof(double));
 var->p2 = (double*) malloc( M*sizeof(double));

 var->d1 = (double*) malloc( M*sizeof(double));
 var->d2 = (double*) malloc( M*sizeof(double));

 var->sk1m1 = (double*) malloc( M*sizeof(double));
 var->sk2m1 = (double*) malloc( M*sizeof(double));

 var->p1 = (double*) malloc( M*sizeof(double));
 var->p2 = (double*) malloc( M*sizeof(double));

 var->rs1 = (double*) malloc( M*sizeof(double));
 var->rs2 = (double*) malloc( M*sizeof(double));

 var->rhs = (double*) malloc( sig.n*sizeof(double));
 var->r1 = (double*) malloc( sig.n*sizeof(double));
 var->r2 = (double*) malloc( M*sizeof(double));

 var->rc1 = (double*) malloc( sig.n*sizeof(double));
 var->rc2 = (double*) malloc( M*sizeof(double));

 var->tM = (double*) malloc( M*sizeof(double));
 var->tM2 = (double*) malloc( M*sizeof(double));

 var->d = (double*) malloc( M*sizeof(double));
 var->d1pd2m1 = (double*) malloc( M*sizeof(double));

 var->dv = (double*) malloc( M*sizeof(double));

 var->zk1m1 = (double*) malloc( M*sizeof(double));
 var->zk2m1 = (double*) malloc( M*sizeof(double));

 var->dza1 = (double*) malloc( M*sizeof(double));
 var->dza2 = (double*) malloc( M*sizeof(double));

 var->dsa1 = (double*) malloc( M*sizeof(double));
 var->dsa2 = (double*) malloc( M*sizeof(double));

 var->dzs1 = (double*) malloc( M*sizeof(double));
 var->dzs2 = (double*) malloc( M*sizeof(double));

 var->dss1 = (double*) malloc( M*sizeof(double));
 var->dss2 = (double*) malloc( M*sizeof(double));

 var->Kp = (double*) malloc( sig.n*sig.n*sizeof(double));

 var->Kpp = (double*) malloc( sig.n*sig.n*sizeof(double));

 var->T = (double*) malloc( sig.n*sig.m*sizeof(double));


 var->L = 3*(sig.m < sig.n ? sig.m : sig.n) + ((sig.m < sig.n ? sig.n : sig.m) < 4*(sig.m < sig.n ? sig.m : sig.n)*(sig.m < sig.n ? sig.m : sig.n)+3*(sig.m < sig.n ? sig.m : sig.n)+(sig.m < sig.n ? sig.n : sig.m) ? 4*(sig.m < sig.n ? sig.m : sig.n)*(sig.m < sig.n ? sig.m : sig.n)+3*(sig.m < sig.n ? sig.m : sig.n)+(sig.m < sig.n ? sig.n : sig.m) : (sig.m < sig.n ? sig.n : sig.m));

 var->work = (double*) malloc( var->L*sizeof(double));
  var->iwork = (int*) malloc( 8*(sig.m < sig.n ? sig.m : sig.n)*sizeof(int));

 var->s = (double*) malloc( sig.n*sizeof(double));

 var->U = (double*) malloc( sig.m*sig.n*sizeof(double));
 var->Vt = (double*) malloc( sig.n*sig.n*sizeof(double));

 var->t1 = (double*) malloc( sig.n*sizeof(double));
 var->t2 = (double*) malloc( sig.n*sizeof(double));
 var->t3 = (double*) malloc( sig.n*sizeof(double));
