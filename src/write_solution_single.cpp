...
# 5 "write_solution.cpp" 2
# 19 "write_solution.cpp"
...
# 20 "write_solution.cpp" 2
# 29 "write_solution.cpp"
int write_solution(char *fn, int n, solution_single sol, float time){
 FILE *f;
 int i;
